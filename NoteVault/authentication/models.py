...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    first_name = models.CharField(
        "First name", max_length=20, default=None, null=True, blank=True
    )
    last_name = models.CharField(
        "Last name", max_length=20, default=None, null=True, blank=True
    )
    ...
    def __str__(self):
        ...
        """
        return f"id: {self.id},{self.first_name} {self.last_name}, email: {self.email}"  # f", 'created_at': {int(self.created_at.timestamp())}, 'updated_at': {int(self.updated_at.timestamp())}, 'role': {self.role}, 'is_active': {self.is_active}"  # 'password': '{self.password}', \
    ...
    def update(self, first_name=None, last_name=None, password=None, is_active=None):
        """
